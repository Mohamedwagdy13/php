...
<div class="container mt-5">
    ...
    <div class="alert alert-success" role="alert">
        ...
        <span>Your form has been submitted successfully with the email: <strong><?= htmlspecialchars($email)?></strong>.</span>
        <hr>
...
<form>
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="email" class="form-control" id="inputEmail4" placeholder=<?= htmlspecialchars($email)?>>
    </div>
  </div>
